...
import SetContentRecord from "../SetContentRecord/SetContentRecord";
	...
	const getContent = (type: string) => {
		switch (type) {
			...
			case "Registration Info":
				return <RegistrationProcess {...props?.data} />;
			case "Extend Expiry":
			...
			case "Set Content Record":
				return <SetContentRecord {...props?.data} />;
			default:
				return;
		}
	};
