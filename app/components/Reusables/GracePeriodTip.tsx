...
export const GracePeriodTip: React.FC<GracePeriodProps> = (
  ...
  const { expiryDate, gracePeriod } = props;
  ...
  return inGracePeriod ? (
    <GraceContainer>
      ...
      <GraceTip>
        ...
        <HighlightTip> {remainingGrace.label}</HighlightTip>. When the identity
        is not extended before the grace period ends, it will be available for
        registration.
      </GraceTip>
    </GraceContainer>
  ) : (
